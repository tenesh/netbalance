...
export const SideBar = ({ isOpen, toggleOpen, children }: SideBarProps) => {
    ...
    return (
        <div
            className={`${isOpen ? 'flex' : 'hidden'} min-w-screen absolute left-0 top-0 h-screen border-r border-neutral-200 bg-neutral-900/20 xl:relative xl:flex xl:min-w-[253px]`}
        >
